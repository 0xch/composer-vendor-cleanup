...
class CleanupRules
{
    public static function getRules()
    {
        ...
        return [
            ...
            'sebastian/object-reflector' => [$docs, $tests],
            ...
            'react/event-loop' => [$docs, $tests, 'examples'],
            'windwalker/renderer' => [$docs, $tests],
            'windwalker/structure' => [$docs, $tests],
            'mpociot/reflection-docblock' => [$docs, $tests],
            'pdepend/pdepend' => [$docs, 'scripts'],
            'webpatser/laravel-uuid/' => [$docs, $tests],
        ];
    }
}
